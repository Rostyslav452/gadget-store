...
- **Routing:** React Router v6 (dynamic routes, URL-based state for pagination/sorting)
...
```bash
git clone [https://github.com/Rostyslav452/gadget-store.git](https://github.com/Rostyslav452/gadget-store.git)
cd gadget-store
npm i
npm start
```
